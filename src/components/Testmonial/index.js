...
const sliders = [
  {
    text: 'Respect, attention and professionalism are the aspects in which the work with its clients stands out."',
    images: testmonial2,
    title: "José Hernández",
    subTitle: "Gerente, Aroindustrias Patito",
  },
  {
    text: 'The most outstanding and professional legal service in Rocky Point."',
    images: testmonial2,
